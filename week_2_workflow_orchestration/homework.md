...
```
prefect deployment build flows/02_gcp/etl_web_to_gcs.py:etl_web_to_gcs -n "Deployment ETL Web to GCS" --cron "0 5 1 * *"
```
...
```
prefect deployment build flows/03_deployments/parameterized_flow_etl_gcs_to_bq.py:etl_parent_flow -n "Deployment ETL GCS to BQ"
